import{j as c}from"./jsx-runtime-B4Xyeazo.js";import{r as u}from"./iframe-CQ3VgYSw.js";import{B as s}from"./_TextField-DtK5qcPA.js";const m={component:s,args:{disabled:!1,color:"primary",variant:"filled",children:"Default button"},argTypes:{disabled:{control:"boolean"},color:{control:"select",options:["primary","secondary"]},variant:{control:"select",options:["filled","outlined"]},status:{control:"select",options:[void 0,"info","success","warning","error"]}},tags:["autodocs"],parameters:{layout:"centered"}},o={render:a=>{const t=u.useRef(null),l=()=>{console.log(t.current)};return c.jsx(s,{...a,onClick:l,ref:t})},args:{children:"Button"}};var r,e,n;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: args => {
